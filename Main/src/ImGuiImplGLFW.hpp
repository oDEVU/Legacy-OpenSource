...
{
public:
    static std::unique_ptr<ImGuiImplGLFW> Create(const ImGuiDiligentCreateInfo& CI, GLFWwindow *window, int backend);

    ImGuiImplGLFW(const ImGuiDiligentCreateInfo& CI, GLFWwindow *window, int backend);
    ~ImGuiImplGLFW();
